...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    date: "Sep 2024 – Dec 2024",
    description: [
      "C Programming TA: Assisted students in C programming labs, providing guidance on debugging, data structures, and algorithm implementation.",
      "Engineering 101 TA (Electrical & CS): Helped students with foundational concepts in circuits, theremin, Arduino, and basic principles."
    ],
  },
  {
  ...
  },
  {
    ...
    date: "Sep 2021 – Sep 2021",
    description: [
      "Developed a crawler to automate the download of tender files from the Karnataka e-Procurement website in a team of two."
    ],
  },
];
