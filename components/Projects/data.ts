...
export const techIcons: { [key: string]: string } = {
  ...
  HuggingFace: "/Icons/huggingFace.png",
  NLP: "/Icons/nlp.png",
  OpenCV: "/Icons/opencv.svg", // Optional: Add an OpenCV icon if you have one
  Streamlit: "/Icons/streamlit.svg", // Optional: if used
};
...
export const projects: Projects[] = [
  ...
  },
  {
    ...
    href: "https://github.com/jannat226/TennisAnalysis",
    description:
      "Analyzes tennis videos to track players, balls, and court lines while providing real-time statistics and visualizations.\nFeatures include player tracking, speed calculations, mini-court overlays, and court line detection. Built using computer vision with YOLOv8, keypoint extraction, and Streamlit for the UI.",
    date: "June 2025",
  ...
  },
  {
    ...
    href: "https://github.com/jannat226/ridesharee",
    description:
      "Applied user interface to book a ride with nearby drivers who want to share their cab and vice versa, both working synchronously.\nUtilized Open Street Maps API for location-based services.\nPresented the project at the International Conference on Engineering Advancements and Sustainable Development at Ramaiah College.",
    date: "May 2022",
    stack: ["Next.js", "React.js", "Typescript", "Node.js"],
  },
  {
    ...
    href: "https://bitbucket.org/jannatjiya/karnataka_eprocurement/src/main/tender_test/test_tender.py",
    description:
      "Implemented automation to download all tenders from a government procurement website using Selenium and Python.",
    date: "May 2023",
    stack: ["Selenium", "Firebase", "Python"],
  },
];
