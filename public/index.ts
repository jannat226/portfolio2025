export const navItems = [
  ...
  { name: "Expericence", link: "#experiences" },
...
//     title: "I prioritize client collaboration, fostering open communication",
//     description: "",
//     className: "sm:col-span-1 sm:row-span-1 md:col-span-2 md:row-span-2",
//     imgClassName: "w-full h-full",
//     titleClassName: "justify-end",
//     img: "/b1.svg",
//     spareImg: "",
...
//     title: "I'm very flexible with time zone communications",
//     description: "",
//     className: "sm:col-span-1 sm:row-span-1 md:col-span-1 md:row-span-1",
//     imgClassName: "",
//     titleClassName: "justify-start",
//     img: "",
//     spareImg: "",
...
//     title: "Currently building a JS Animation library",
//     description: "The Inside Scoop",
//     className: "sm:col-span-1 sm:row-span-1 md:col-span-2 md:row-span-1",
//     imgClassName: "absolute right-0 bottom-0 md:w-96 w-60",
//     titleClassName: "justify-center md:justify-start lg:justify-center",
//     img: "/b5.svg",
//     spareImg: "/grid.svg",
...
//     title: "Do you want to start a project together?",
//     description: "",
//     className: "sm:col-span-1 sm:row-span-1 md:col-span-3",
//     imgClassName: "",
//     titleClassName: "justify-center md:max-w-full max-w-60 text-center",
//     img: "",
//     spareImg: "",
...
export const workExperience = [
  {
    id: 1,
    title: "Software Engineer Intern-Raceme Tenders LLP",
    desc: "Assisted in the development of a web-based platform by upgrading the old website created using php, enhancing interactivity.",
  ...
  },
  {
    id: 2,
    title: "Software Engineer Intern-Raceme Tenders LLP",
    desc: "Developed a crawler using python, selenium to reduce the manually downloading of projects ",
